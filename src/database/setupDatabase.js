    ...
    return __awaiter(this, void 0, void 0, function () {
        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                    _a.trys.push([0, 3, , 4]);
                    return [4 /*yield*/, databasePool_1.default.connect()];
                case 1:
                    client = _a.sent();
                    // Execute the SQL commands to create the schema
                    return [4 /*yield*/, client.query(createSchemaQuery)];
                case 2:
                    // Execute the SQL commands to create the schema
                    _a.sent();
                ...
                case 3:
                    error_1 = _a.sent();
                    console.error('Error creating database schema:', error_1);
                    throw error_1; // Rethrow the error to propagate it to the caller
