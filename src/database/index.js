...
exports.main = void 0;
var setupDatabase_1 = require("./setupDatabase");
var queries_1 = require("./queries");
function main() {
    return __awaiter(this, void 0, void 0, function () {
        var businessData, error_1;
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                    _a.trys.push([0, 3, , 4]);
                    // Call the setupDatabase function to create the schema
                    return [4 /*yield*/, (0, setupDatabase_1.createSchema)()];
                case 1:
                    // Call the setupDatabase function to create the schema
                    _a.sent();
                    businessData = {
                    ...
                    return [4 /*yield*/, (0, queries_1.insertBusinessData)(businessData)];
                case 2:
                    _a.sent();
